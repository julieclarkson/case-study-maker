...
3. When presenting drafts, note if the other IDE has already captured related reflections: "I see a tradeoffs reflection was captured in your Cursor session — skipping that one."
