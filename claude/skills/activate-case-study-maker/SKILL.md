...
CURRENT STEP: Build & Capture
  ...
  /case-study-maker:capture    — manually capture a reflection
  /case-study-maker:auto-capture — I'll draft reflections from conversation
  /case-study-maker:review     — check what's been captured

WHEN YOU'RE READY TO GENERATE OUTPUT:
  /case-study-maker:generate   — generate portfolio, marketing, or custom pages

COMPANION PLUGINS (if installed):
  /demo-maker:activate         — activate Demo Maker
  "make a demo"                — generate demo videos
